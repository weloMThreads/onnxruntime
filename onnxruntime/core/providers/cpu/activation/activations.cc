...
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Log1p, 1, float);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Log1p, 1, double);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Expm1, 1, float);
REGISTER_UNARY_ELEMENTWISE_TYPED_KERNEL(Expm1, 1, double);
