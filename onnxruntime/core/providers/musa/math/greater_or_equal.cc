...
#define REGISTER_MUSA_GREATER_EQUAL_TYPED_KERNEL(ver, T)                         \
  ONNX_OPERATOR_TYPED_KERNEL_EX(                                             \
      GreaterEqual, kOnnxDomain, ver, T, kMusaExecutionProvider,                 \
      (*KernelDefBuilder::Create())                                          \
          .TypeConstraint("T", DataTypeImpl::GetTensorType<T>())             \
          .TypeConstraint("T1", DataTypeImpl::GetTensorType<bool>()),        \
      GreaterOrEqual<T>);

REGISTER_MUSA_GREATER_EQUAL_TYPED_KERNEL(1, int32_t)
REGISTER_MUSA_GREATER_EQUAL_TYPED_KERNEL(1, int64_t)
REGISTER_MUSA_GREATER_EQUAL_TYPED_KERNEL(1, MLFloat16)
REGISTER_MUSA_GREATER_EQUAL_TYPED_KERNEL(1, float)
