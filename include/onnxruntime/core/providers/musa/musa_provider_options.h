...
struct OrtMUSAProviderOptions {
#ifdef __cplusplus
  OrtMUSAProviderOptions() : device_id{0}, prefer_nhwc{0}, enable_musa_graph{0}, use_tf32{0}, use_bf16{0} {}
#endif
  ...
  int use_bf16; // Enable BF16 fast math for FP32 MatMul where supported (0 = strict FP32, 1 = faster BF16)
};
